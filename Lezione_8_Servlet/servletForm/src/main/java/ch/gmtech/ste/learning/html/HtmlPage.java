...
public class HtmlPage{
	...
	public String renderValidatedFormBody(String name, Integer number, Integer seats, String location, String description, Date startDate){
						...
						div().withClass("row").with(
								div().withClass("col-md-6 col-md-offset-3").with(
										...
										form().withId("courseForm").withClass("form-horizontal").withMethod("post").with(
												...
												createValidationInput(name,"text","courseName","name","Course Name"),
												createValidationInput(number.toString(),"number","number","number","Number"),
												createValidationInput(seats.toString(),"number","seats","seats","TotalSeats"),
												createValidationInput(location,"text","location","location","Location"),
												createValidationInput(description,"text","description","description","Description"),
												createValidationInput(startDate.toString(),"date","startdate","startdate","StartDate"),
												createSubmit(),
												script().withSrc("/js/jquery.min.js"),
												script().withSrc("/js/bootstrap.min.js")
												)
